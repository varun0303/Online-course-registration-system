...
<button onclick="this. style. display='none'" name="python" class="btn">Join</button>
</form>
<div class="sub"><h3>
<?php
if (isset($_POST['python'])) { 
    ...
    $id=$rows['id'];
    $emaill=$rows['email'];
	$sql="INSERT INTO course values('$id','Python')";
...
You have successfully registered for Python Course!

Thank you for signing up for our online course "Python". We wish you an enjoyable and informative learning experience.
