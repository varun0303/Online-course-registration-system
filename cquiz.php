...
<div class="cor">
	<h1>Begin : C Programming Viva Assignment</h1><br>
	<div class="box">
...
<a href="java1.php"><button  name="pythonn" class="btn1">Cancel</button></a>
		
<a href="quiz/cpquiz.php"><button name="javaaa" class="btn">Begin</button></a>
</div><br>
	</div>
	<br><br>
</div>
