...
<button onclick="this. style. display='none'" name="c" class="btn">Join</button>
</form>
<div class="sub"><h3>
<?php
if (isset($_POST['c'])) {
    ...
    $id=$rows['id'];
     $emaill=$rows['email'];
	$sql="INSERT INTO course values('$id','C Programming')";
...
You have successfully registered for C Programming Course!

Thank you for signing up for our online course "C Programming". We wish you an enjoyable and informative learning experience.
