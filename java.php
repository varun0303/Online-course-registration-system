...
<button onclick="this. style. display='none'" name="java" class="btn">Join</button>
</form>
<div class="sub"><h3>
<?php
if (isset($_POST['java'])) {
    ...
    $id=$rows['id'];
       $emaill=$rows['email'];
    $sql="INSERT into course values('$id','Java')";
...
You have successfully registered for Java Course!

Thank you for signing up for our online course "Java". We wish you an enjoyable and informative learning experience.
