...
<div class="panel">
 <li><a href="sql/1sql.php">Server Installation and Tables</a></li>
<hr>
<li><a href="sql/2sql.php">create,drop and data types</a></li><hr>
<li><a href="sql/3sql.php">Create and Select Statement</a></li>
</div><hr>
<button class="accordion">
  <h3>Lesson 2</h3>
</button>
<div class="panel">
 <li><a href="sql/4sql.php">Where, And, Or and Not</a></li>
<hr>
<li><a href="sql/5sql.php">Inner and Left Join</a></li><hr>
<li><a href="sql/6sql.php">Right and Full Join</a></li>
</div><hr>
<button class="accordion">
  <h3>Lesson 3</h3>
</button>
<div class="panel">
 <li><a href="sql/7sql.php">Update and Merge Statements</a></li>
<hr>
<li><a href="sql/8sql.php">Alter and Functions in Sql</a></li><hr>
<li><a href="sql/9sql.php">String functions, Case Statements</a></li>
</div><hr>
...
<div class="panel">
 <li><a href="sql/10sql.php">Order by and Group by Clause</a></li>
<hr>
<li><a href="sql/11sql.php">Having and Union Clause</a></li><hr>
<li><a href="sql/12sql.php">Except and Intersect Clause</a></li>
</div>
<hr>
<button class="accordion">
  <h3>Assignment</h3>
